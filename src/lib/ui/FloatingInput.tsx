...
import { Animated, ScrollView, StyleSheet, TextInput, View, Text } from 'react-native';
...
export default function FloatingInput({ value, onChange, placeholder, multiline }: AnimatedInputProps) {
